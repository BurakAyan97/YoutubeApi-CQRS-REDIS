...
namespace YoutubeApi.Infrastructure.RedisCache
{
    public class RedisCacheService : IRedisCacheService
    {
        ...
        public RedisCacheService(ConnectionMultiplexer redisConnection, IDatabase database, IOptions<RedisCacheSettings> options)
        {
        ...
        {
            TimeSpan timeUnitExrpiration = expirationTime.Value - DateTime.Now;
            await database.StringSetAsync(key, JsonConvert.SerializeObject(value), timeUnitExrpiration);
